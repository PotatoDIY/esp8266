...
int data = D5;    // DIN pin of MAX7219 module
int load = D6;    // CS pin of MAX7219 module
int clockpin = D7;  // CLK pin of MAX7219 module

int maxInUse = 1;    //change this variable to set how many MAX7219's you'll use

MaxMatrix m(data, load, clockpin, maxInUse); // define module
